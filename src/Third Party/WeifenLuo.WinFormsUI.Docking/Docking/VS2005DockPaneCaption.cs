...
namespace WeifenLuo.WinFormsUI.Docking
{
	internal class VS2005DockPaneCaption : DockPaneCaptionBase
	{
		...
		private static readonly Color activeBackColorGradientBegin = Color.FromArgb(143, 173, 206);
		private static Color ActiveBackColorGradientBegin
		{
            get { return activeBackColorGradientBegin; }
        }

		private static readonly Color activeBackColorGradientEnd = Color.FromArgb(189, 211, 239);
        private static Color ActiveBackColorGradientEnd
        {
			get { return activeBackColorGradientEnd; }
        }

		private static readonly Color inactiveBackColorGradientBegin = Color.FromArgb(183, 202, 224);
		private static Color InactiveBackColorGradientBegin
		{
			get { return inactiveBackColorGradientBegin; }
		}

		private static readonly Color inactiveBackColorGradientEnd = Color.FromArgb(232, 240, 255);
		private static Color InactiveBackColorGradientEnd
		{
			get { return inactiveBackColorGradientEnd; }
		}
